...
const services = [
  { title: "Сімейне право", text: "Делікатний супровід сімейних спорів, договорів та захисту інтересів дітей.", icon: Users },
  { title: "Господарські спори", text: "Стратегія, претензійна робота та представництво у складних B2B-конфліктах.", icon: Gavel },
  { title: "Реєстрація бізнесу", text: "Підбір структури, підготовка документів і запуск компанії без зайвої бюрократії.", icon: Building2 },
  { title: "Податкове право", text: "Аудит ризиків, оскарження рішень та супровід перевірок контролюючих органів.", icon: Landmark },
  { title: "Юридичний супровід компаній", text: "Абонентське обслуговування, договори, комплаєнс та щоденна правова підтримка.", icon: BriefcaseBusiness },
  { title: "Представництво в суді", text: "Побудова позиції, процесуальні документи та захист на всіх стадіях розгляду.", icon: Scale }
];
...
const reviews = [
  {
    name: "Олена Марченко",
    role: "Власниця мережі кав'ярень",
    text: "Команда швидко навела лад у договорах з постачальниками та допомогла пройти податкову перевірку без конфлікту."
  },
  {
    name: "Андрій Коваленко",
    role: "CEO IT-компанії",
    text: "Отримали не просто документи, а зрозумілу юридичну стратегію. Особливо ціную швидкість комунікації та спокійний тон у складних моментах."
  },
  {
    name: "Ірина Савчук",
    role: "Приватний клієнт",
    text: "Питання сімейного права вирішили дуже коректно й конфіденційно. Я почувалася захищеною на кожному етапі."
  },
  {
    name: "Дмитро Романюк",
    role: "Фінансовий директор",
    text: "Юристи підготували позицію для господарського спору і супроводжували переговори. Результат перевищив очікування."
  }
];
...
const faqs = [
  ...
  {
    q: "Чи працюєте ви з бізнесом на абонентській основі?",
    a: "Так. Формуємо пакет під обсяг задач: договори, кадрові питання, податки, судові ризики та щоденна правова підтримка."
  },
  {
    ...
    <main className="min-h-screen overflow-hidden bg-ink text-white">
        ...
        <div className="container-shell relative grid min-h-[calc(92svh-7rem)] items-center gap-10 py-16 lg:grid-cols-[1.05fr_.95fr]">
          <motion.div initial={{ opacity: 0, y: 32 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.75 }}>
            ...
            <h1 className="max-w-4xl text-4xl font-semibold leading-[1.08] text-white md:text-6xl lg:text-7xl">
              Юридичний захист та професійний супровід вашого бізнесу
            </h1>
            <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-200 md:text-xl">
              Допомагаємо фізичним та юридичним особам ефективно вирішувати правові питання
            </p>
      ...
      <section id="about" className="bg-white py-24 text-ink">
        <div className="container-shell grid gap-12 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <p className="mb-3 text-sm font-semibold uppercase tracking-[0.28em] text-gold">Про компанію</p>
            <h2 className="text-3xl font-semibold leading-tight md:text-5xl">Правова команда, яка мислить бізнес-результатом</h2>
            <p className="mt-6 text-lg leading-8 text-slate-600">
              Адвокат Канівець Олександр Петрович супроводжує підприємців, компанії та приватних клієнтів у питаннях, де важлива точність, репутація й час. Робота поєднує юридичну експертизу з практичним розумінням бізнес-процесів.
            </p>
          </motion.div>

          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ["Досвід роботи", "Працюємо зі складними кейсами у бізнесі, судах і приватних правових питаннях."],
              ["Професійний підхід", "Будуємо позицію на доказах, ризик-аналізі та зрозумілому плані дій."],
      ...
      <section id="services" className="bg-navy py-24">
        <div className="container-shell">
          <SectionHeading eyebrow="Послуги" title="Комплексний юридичний супровід" text="Беремо на себе правову частину, щоб ви могли ухвалювати рішення без шуму, поспіху й зайвого ризику." />
      ...
      <section id="benefits" className="bg-ink py-24">
        <div className="container-shell grid gap-12 lg:grid-cols-[.95fr_1.05fr] lg:items-center">
          <div>
            <SectionHeading eyebrow="Чому обирають нас" title="Юридична підтримка, що знімає невизначеність" text="Ми не продаємо шаблони. Ми занурюємося в контекст, оцінюємо ризики й пропонуємо рішення, які витримують реальність." />
          </div>
