...
const services = [
  { title: "Кримінальні справи", text: "Захист під час допитів, обшуків, повідомлення про підозру, досудового розслідування та судового розгляду.", icon: Gavel },
  { title: "Митні справи", text: "Порушення митних правил, вилучення товарів, штрафи, протоколи митниці та оскарження рішень.", icon: Landmark },
  { title: "Адміністративні правопорушення", text: "Захист у справах про адмінпротоколи, постанови, штрафи та оскарження дій органів влади.", icon: FileText },
  { title: "Автоправо та ст. 130", text: "ДТП, вилучення посвідчення, огляд на стан сп'яніння, відеофіксація та захист у суді.", icon: Scale },
  { title: "ЄСПЛ", text: "Оцінка перспектив звернення, підготовка позиції та правовий аналіз порушень Конвенції.", icon: ShieldCheck },
  { title: "Судове представництво", text: "Процесуальні документи, стратегія захисту та представництво інтересів на всіх стадіях.", icon: BriefcaseBusiness }
];

const benefits = [
  "Особисте включення в проблему",
  "Швидка оцінка ризиків",
  "Захист на основі доказів",
  "Конфіденційна комунікація"
];

const whyUs = [
  { value: "12+", label: "років юридичної практики" },
  { value: "24/7", label: "готовність до термінових ситуацій" },
  { value: "№21/1279", label: "свідоцтво адвоката" }
];
...
const reviews = [
  {
    name: "Ігор Мельник",
    role: "Водій",
    text: "Після протоколу за ст. 130 потрібно було швидко зрозуміти ризики. Отримав чітку позицію, аналіз доказів і план для суду."
  },
  {
    name: "Марина Гнатюк",
    role: "Клієнтка у митній справі",
    text: "У митній справі важливо було не втратити час. Документи підготували швидко, пояснили процедуру і можливі варіанти захисту."
  },
  {
    name: "Олександр Романюк",
    role: "Приватний клієнт",
    text: "У кримінальному провадженні комунікація була спокійною і конкретною. Було зрозуміло, що робити зараз і чого очікувати далі."
  },
  {
    name: "Василь Ковач",
    role: "Автовласник",
    text: "Після ДТП допомогли з документами та судовою позицією. Сподобалося, що кожен крок пояснювали людською мовою."
  }
];
...
const faqs = [
  ...
  {
    q: "Чи можна звернутися у терміновій ситуації?",
    a: "Так. У кримінальних, митних та адміністративних справах час часто має вирішальне значення, тому важливо звертатися одразу після події або отримання документів."
  },
  {
  ...
  {
    q: "Чи працюєте зі зверненнями до ЄСПЛ?",
    a: "Так. Можу оцінити перспективу звернення, проаналізувати порушення Конвенції та допомогти з підготовкою правової позиції."
  },
  {
    q: "Чи гарантуєте конфіденційність?",
    a: "Так. Усі звернення, документи й переговори захищені адвокатською таємницею."
  }
];
...
function SectionHeading({
  ...
  return (
    ...
    >
      ...
      <h2 className={`text-3xl font-semibold leading-tight md:text-5xl ${isLight ? "text-ink" : "text-white"}`}>{title}</h2>
      {text ? <p className={`mt-5 text-base leading-8 md:text-lg ${isLight ? "text-slate-600" : "text-slate-300"}`}>{text}</p> : null}
    </motion.div>
  );
}
    ...
    <main className="min-h-screen overflow-hidden bg-ink text-white">
      ...
      <section id="about" className="bg-white py-24 text-ink">
        <div className="container-shell grid gap-12 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-3xl font-semibold leading-tight md:text-5xl">Коли ваша проблема стає моєю професійною задачею</h2>
            <p className="mt-6 text-lg leading-8 text-slate-600">
              Адвокат Канівець Олександр Петрович бере на себе правовий захист у ситуаціях, де на кону свобода, репутація, майно, право керування або можливість відстояти справедливість. Фокус роботи: кримінальні справи, митні спори, адміністративні правопорушення, автоправо, ст. 130 КУпАП, ЄСПЛ та судове представництво.
            </p>
          </motion.div>

          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ["Особиста участь", "Ви працюєте безпосередньо з адвокатом, який аналізує матеріали й відповідає за стратегію."],
              ["Процесуальна точність", "Позиція будується на доказах, строках, порушеннях процедури та судовій практиці."],
              ["Конфіденційність", "Інформація, документи та переговори захищені адвокатською таємницею."]
      ...
      <section id="services" className="bg-navy py-24">
        <div className="container-shell">
          <SectionHeading eyebrow="Напрями захисту" title="Правова допомога там, де помилка коштує дорого" text="Кожна справа починається з аналізу документів, доказів, строків і ризиків. Далі формується стратегія: переговори, скарги, процесуальні документи або захист у суді." />
      ...
      <section id="benefits" className="bg-ink py-24">
        <div className="container-shell grid gap-12 lg:grid-cols-[.95fr_1.05fr] lg:items-center">
          <div>
            <SectionHeading eyebrow="Підхід до справи" title="Не шаблон, а захист під конкретну ситуацію" text="Ваше питання розглядається не як формальність, а як особиста правова задача: що сталося, які докази є, де ризики, які строки і який результат реально досягати." />
          </div>
      ...
      <section className="bg-white py-24 text-ink">
        <div className="container-shell">
          <SectionHeading tone="light" eyebrow="Відгуки клієнтів" title="Довіра, підтверджена практикою" />
      ...
      <section id="consultation" className="bg-midnight py-24">
        <div className="container-shell grid gap-12 lg:grid-cols-[.9fr_1.1fr] lg:items-center">
          <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <h2 className="text-3xl font-semibold leading-tight md:text-5xl">Опишіть проблему — я підкажу перший правовий крок</h2>
            <p className="mt-6 text-lg leading-8 text-slate-300">
              Напишіть, що сталося, коли це відбулося і які документи вже є. Після цього можна визначити формат роботи: консультація, аналіз матеріалів, підготовка документів або повний захист.
            </p>
